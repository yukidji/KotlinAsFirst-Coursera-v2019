 ...
 */
fun sqrCube(x: Double) = x * x * x
fun accountInThreeYears(initial: Int, percent: Int): Double = initial * sqrCube(1 + percent / 100.0)
...
fun numberRevert(number: Int): Int {
    ...
    val y: Int = (number - x * 100) / 10
    val z: Int = number - (x * 100 + y * 10)
    return z * 100 + y * 10 + x
}
